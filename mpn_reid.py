...
def reid_model(weight_path):
    reid_model = resnet50_fc256(10, loss='xent', pretrained=True).cuda()
    load_pretrained_weights(reid_model, weight_path)
    reid_model.return_embeddings = True
    return reid_model
