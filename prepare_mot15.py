...
if __name__ == '__main__':
    ...
    MOT15_ROOT = Path('/store_2/2DMOT2015/train/')
    MPN15_ROOT = Path('tracktor_detections/2DMOT2015/train/')
    ...
    for name, info in tqdm(INFO.items()):
        ...
        df_det = pd.read_csv(
            MPN15_ROOT / name / 'det' / 'tracktor_prepr_det.txt', header=None
        )
